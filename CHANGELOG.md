...
## [1.2.17] - 2026-07-31
   ...
   -COMP:
      - INIT:
         - Añadimos `batch_renderer'

   -  LIGHTING:
      - Helpers:
         - Render Settings:
            - Quitamos Multipart, da errores.
...
## [1.2.16] - 2026-07-30
   ...
   -  LIGHTING:
      - Helpers:
         - Render Settings:
            - Ponemos la compresión del EXR en ZIPS (ZIP1)
            - Seteamos el EXR como Multipart
...
## [1.2.13] - 2026-07-15
   ...
   - COMP:
      - Init:
         - Añadimos `Nuke-AI-Denoiser-main` para test.
...
## [1.2.5] - 2026-05-28
   ...
   - FLAY:
      - ExportCaches --> Añadimos una función para exportar cámaras en FLAY

## [1.2.4] - 2026-05-27

   - PUBLISH VERSION:
      - LIGHTING --> EXPORTERS --> Faltaba importar el modulo `userPrefs`

## [1.2.3] - 2026-05-27

   - FLAY:
      - Helpers --> Arreglamos el cambio a STD de los pinos

   - Exporters:
      - Añadimos `export_render_setup()` para exportar el json de render

   - Publish Version:
      - Lighting --> Exportamos el grupo LIGHTS como LightSet en ma y el Render Setup (Layers + Settings) como Json
...
## [1.1.26] - 2026-05-13
   ...
   - ANIM PUBLISHER:
      - Añadimos a Elia para que pueda publicar alembics por separado.
